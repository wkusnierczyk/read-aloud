...
def main():
    ...
    parser.add_argument("--speed", "-s", type=float, default=1.0, help="Speed multiplier (e.g., 1.5 for 1.5x speed)")
    ...
    engine.load_text(content) \
          .set_properties(voice_name=args.voice, speed_multiplier=args.speed) \
          .speak()
